...
// Filtrar búsqueda
$where = "estado = 'aprobado'"; // IMPORTANTE: Solo mostrar aprobados
        ...
        <div class="nav-links">
            ...
            <?php if(isset($_SESSION['uid'])): ?>
                ...
                <?php if($_SESSION['rol'] == 'admin'): ?>
                    <a href="admin_panel.php" style="color:#eab308; font-weight:bold;">Panel Control</a>
                <?php endif; ?>
    ...
    <div class="hero-wrapper">
        <div class="hero">
            <div class="hero-overlay"></div> <div class="hero-content">
                <h1>Comparte y Descubre<br>Conocimiento sin límites.</h1>
                <?php if(isset($_GET['msg']) && $_GET['msg']=='uploaded'): ?>
                    <div class="alert alert-success" style="margin-top:20px;">¡Gracias! Tu aporte está en revisión.</div>
                <?php endif; ?>
            </div>
        </div>
    </div>
            ...
            <div class="book-card" style="position:relative;">
                ...
                <div class="<?php echo !$isLoggedIn ? 'blur-content' : ''; ?>">
                    ...
                    <div class="book-body">
                        ...
                        <?php else: ?>
                            <span class="btn-outline" style="opacity:0.5;">Bloqueado</span>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <div class="locked-overlay">
                    ...
                    <p style="font-size:0.8rem; margin-bottom:15px;">Inicia sesión para ver y descargar.</p>
