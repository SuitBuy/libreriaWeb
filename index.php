...
if (isset($_GET['q']) && $_GET['q'] != '') {
    ...
    // Buscamos por título, autor libro O nombre del usuario que subió
...
// CONSULTA CON JOIN PARA OBTENER EL NOMBRE DEL UPLOADER
...
<head>
    ...
    <style>
        .preview-container { width: 100%; height: 250px; background-color: #f1f5f9; overflow: hidden; display: flex; align-items: center; justify-content: center; border-bottom: 1px solid #e2e8f0; position: relative; }
        .preview-img { width: 100%; height: 100%; object-fit: cover; display: block; }
        .preview-pdf { width: 100%; height: 100%; border: none; pointer-events: none; overflow: hidden; }
        .click-shield { position: absolute; top: 0; left: 0; width: 100%; height: 100%; z-index: 5; background: transparent; cursor: pointer; }
        /* Estilo para la etiqueta de subido por */
        .uploader-tag { font-size: 0.8rem; color: #64748b; background: #f8fafc; padding: 3px 8px; border-radius: 6px; display: inline-block; margin-top: 8px; }
    </style>
</head>
<body>
    <nav class="navbar">
        <div class="logo"><div class="logo-icon"></div> <span style="margin-left: 10px;">Urban Canvas</span></div>
        <div class="nav-links">
        ...
        <div class="hero">
            <div class="hero-overlay"></div> <div class="hero-content">
                ...
                <form method="GET" class="search-container">
                    ...
                    <select name="cat" class="search-select"><option>Todas</option><option>Ciencias</option><option>Arte</option><option>Historia</option></select>
