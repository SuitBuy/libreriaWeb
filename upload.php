...
<body style="background:#f1f5f9;">
    ...
    <div class="auth-wrapper" style="max-width:600px;">
        <h2>Aportar a la Comunidad</h2>
        <p style="color:#64748b; margin-bottom:20px;">Tu archivo será revisado por un administrador antes de publicarse.</p>
        ...
        <form method="POST" enctype="multipart/form-data">
            ...
            <div style="margin:20px 0; padding:20px; border:2px dashed #cbd5e1; border-radius:15px; text-align:center;">
                <p>Soporta: PDF, Word, JPG, PNG</p>
                <input type="file" name="archivo" accept=".pdf,.doc,.docx,.jpg,.png" required>
            </div>
