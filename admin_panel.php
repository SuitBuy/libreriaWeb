...
if (isset($_GET['action']) && isset($_GET['id'])) {
    ...
    if ($action == 'approve') {
        ...
        header("Location: admin_panel.php?msg=deleted"); exit;
    }
}

// 1. PENDIENTES - OPTIMIZADO (Sin columna 'datos')
$query_pendientes = "SELECT r.id, r.titulo, r.autor_nombre, r.categoria, r.tipo_archivo, r.estado, u.nombre AS nombre_uploader 
                     FROM recursos r 
...
// 2. APROBADOS - OPTIMIZADO (Sin columna 'datos')
...
$query_aprobados = "SELECT r.id, r.titulo, r.autor_nombre, r.categoria, r.tipo_archivo, r.estado, u.nombre AS nombre_uploader 
                    FROM recursos r 
                    JOIN usuarios u ON r.usuario_id = u.id 
