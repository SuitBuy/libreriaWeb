...
// --- CONSULTAS CON JOIN PARA OBTENER EL NOMBRE DEL USUARIO ---

// 1. Pendientes (Unimos con la tabla usuarios para sacar el nombre)
$query_pendientes = "SELECT r.*, u.nombre AS nombre_uploader 
                     FROM recursos r 
...
// 2. Aprobados (Con Buscador y Join)
$where_aprobados = "r.estado = 'aprobado'";
$search_term = "";

if (isset($_GET['search']) && !empty($_GET['search'])) {
    $search_term = mysqli_real_escape_string($conn, $_GET['search']);
    // Buscamos también por el nombre del usuario que subió
...
$query_aprobados = "SELECT r.*, u.nombre AS nombre_uploader 
                    FROM recursos r 
                    JOIN usuarios u ON r.usuario_id = u.id 
...
<body>
    ...
    <div class="container" style="margin-top:40px;">
        ...
        <form method="GET" style="margin-bottom:30px; display:flex; gap:10px;">
            <input type="text" name="search" class="input-field" placeholder="Buscar por título, autor, usuario..." value="<?php echo $search_term; ?>" style="margin:0;">
            ...
            <div class="book-card">
                ...
                <div class="book-body">
                    ...
                    <div style="margin-top:20px; display:flex; gap:10px;">
                        ...
                        <a href="admin_panel.php?action=delete&id=<?php echo $row['id']; ?>" onclick="return confirm('¿Eliminar permanentemente?');" class="action-btn btn-delete" style="flex:1; text-align:center;">
