...
if (isset($_GET['action']) && isset($_GET['id'])) {
    ...
    if ($action == 'approve') {
        ...
        header("Location: admin_panel.php"); // Recargar para limpiar URL
        exit;
    } 
    ...
    elseif ($action == 'delete') {
        // 1. Obtener ruta del archivo para borrarlo del servidor
        $query = mysqli_query($conn, "SELECT archivo_pdf FROM recursos WHERE id = $id");
        ...
        mysqli_query($conn, "DELETE FROM comentarios WHERE recurso_id = $id"); // Borrar comentarios asociados
...
// 2. Aprobados (Con Buscador)
$where_aprobados = "estado = 'aprobado'";
$search_term = "";

if (isset($_GET['search']) && !empty($_GET['search'])) {
    $search_term = mysqli_real_escape_string($conn, $_GET['search']);
    $where_aprobados .= " AND (titulo LIKE '%$search_term%' OR autor_nombre LIKE '%$search_term%' OR categoria LIKE '%$search_term%')";
}

$aprobados = mysqli_query($conn, "SELECT * FROM recursos WHERE $where_aprobados ORDER BY id DESC");
?>
<!DOCTYPE html>
<html>
<head>
...
<body>
    ...
    <div class="container" style="margin-top:40px;">
            ...
            <div class="grid">
                ...
                <div class="book-card" style="border:2px solid #f59e0b;">
                    <div class="book-body">
                        ...
                        <p style="font-size:0.9rem;">Por: <strong><?php echo $row['autor_nombre']; ?></strong></p>
                        
                        <div style="margin-top:15px; display:flex; gap:5px;">
                            <a href="<?php echo $row['archivo_pdf']; ?>" target="_blank" class="action-btn" style="background:#64748b; color:white; flex:1; text-align:center;">Ver</a>
        ...
        <form method="GET" style="margin-bottom:30px; display:flex; gap:10px;">
            <input type="text" name="search" class="input-field" placeholder="Buscar por título, autor o categoría..." value="<?php echo $search_term; ?>" style="margin:0;">
        ...
        <div class="grid">
            ...
            <div class="book-card">
                ...
                <div class="book-body">
                    ...
                    <p style="color:#64748b; font-size:0.9rem;">Autor: <?php echo $row['autor_nombre']; ?></p>
                    
                    <div style="margin-top:20px; display:flex; gap:10px;">
                        <a href="editar_recurso.php?id=<?php echo $row['id']; ?>" class="action-btn btn-edit" style="flex:1; text-align:center;">
                            <i class="fa-solid fa-pen"></i> Editar
                        </a>
                        <a href="admin_panel.php?action=delete&id=<?php echo $row['id']; ?>" onclick="return confirm('¿Estás seguro de eliminar este archivo permanentemente?');" class="action-btn btn-delete" style="flex:1; text-align:center;">
